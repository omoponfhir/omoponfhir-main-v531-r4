...
This package is tested with Google Big Query instance. And, the server supports mapping for FHIR R4 and OMOP v5.3.1. Please see omopv5_3_setup/ folder for some help on ddls for extra tables/views. Database ddls are also included. 
...
```
git clone --recurse https://github.com/omoponfhir/omoponfhir-main-v531-r4.git
cd omoponfhir-main-v531-r4/
mvn clean install
